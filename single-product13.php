...
<section class="product">
	<div class="product__photo">
		<div class="photo-container">
			<div class="photo-main">
           	...
           	<img class='profile' src="240_F_263905033_4Ff6zK6gOb9ya6aGjIFycLu1pmhheXtY.jpg">
   ...
   <?php }   ?>
		<div class="description">
			...
			<ul>
            <li> Georgia O'Keeffe was widely noticed for his "drip technique" of pouring or splashing liquid household paint onto a horizontal surface, enabling him to view and paint his canvases from all angles.</li>
