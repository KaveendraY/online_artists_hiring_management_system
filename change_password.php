...
$sql=mysqli_query($conn,"SELECT password FROM artist where password='$oldpassword'");

if($sql>0)
{
$adminid=$_SESSION['artistid'];
$ret=mysqli_query($con,"update artist set password='$newpassword' where Ar_id='$adminid'");
