...
<section class="product">
	<div class="product__photo">
		<div class="photo-container">
			<div class="photo-main">
           	...
           	<img class='profile' src="240_F_257036581_9rovzPwuLB0HcJET6hUVaPZou1AJ0fXz.jpg">
	...
	<div class="product__info">
		...
		<div class="price">
			For 1 hour $ <span>78</span>
		</div>
   <?php }   ?>
		<div class="description">
			
			<ul>
           <li> A unique and visually beautiful addition to any event, the Hip-pop Barry Lather will captivate any audience. Combining graceful acrobatics and amazing balancing displays, with glitter continuously falling over them, the Magical Snowdome is a striking act </li>
