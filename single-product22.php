...
<section class="product">
	<div class="product__photo">
		<div class="photo-container">
			<div class="photo-main">
           	...
           	<img class='profile' src="240_F_270299495_SDZb4QSMKtASvOAdFgWOSHFfxK0lbQjt.jpg">
   ...
   <?php }   ?>
		<div class="description">
			...
			<ul>
           <li> Meet our beautiful Anna Pavlova inspired ballerinas performing stunning choreography on ballet pointe! With amazing large wings, this enchanting act will create the ultimate spectacle at your next event! Mesmerising, highly-visual and unique!</li>
