      ...
      empty($_POST['url'])) {
           ...
           if($Password!=$Cpassword)
           {
            ...
            if(mysqli_num_rows($result1) > 0){
               ...
               $pass=md5($Password);
               $sql =" INSERT INTO artist( username, Email, Ph_no, password, District, price, Act_type, Style, inturl, fburl, eventtype,Type,status)  VALUES  ('$Username','$Email','$Tel','$pass','$dis','$price','$Type','$Style','$website','$FB','$Do','Painter','pending')";
               ...
               else
               {
                ...
                echo "<script type='text/javascript'> document.location = 'form4.html'; </script>";
               }
