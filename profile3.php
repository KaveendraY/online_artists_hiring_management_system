...
if(isset($_POST['update']))
{
    ...
    $contact=$_POST['num'];
    $userid=$_GET['uid'];
    $msg=mysqli_query($conn,"update payment set cvv='$start',card_no='$$contact,exp='$$contact' where id='$userid'");

if($msg)
{
    echo "<script>alert('Profile updated successfully');</script>";
       echo "<script type='text/javascript'> document.location = 'manage-hire.php'; </script>";
}
}
...
{?>
                        <h1 class="mt-4"><?php echo $result['artist_name'];?>'s hired</h1>
                        <div class="card mb-4">
                     <form method="post">
                            <div class="card-body">
