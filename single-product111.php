...
<section class="product">
	<div class="product__photo">
		<div class="photo-container">
			<div class="photo-main">
           	...
           	<img class='profile' src="240_F_259120780_i1TUNe8LAw4K2IY6FjKkdWgQKkiooCdN.jpg">
   ...
   <?php }   ?>
		<div class="description">
			...
			<ul>
            <li>An experienced Actor</li>
				<li>who accompanies herself on guitar</li>
				<li> with live loops, </li>
				<li> vocal harmonies & beat boxing! </li>
				<li>Performing upbeat classic pop &</li>
				<li>current chart hits plus chilled out acoustic tracks</li>
				<li> LJ offers something for everyone!</li>
